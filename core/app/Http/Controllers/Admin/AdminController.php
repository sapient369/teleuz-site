...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $item['single']  = Item::singleItems()->count();
        $item['episode'] = Item::episodeItems()->count();
        $item['trailer'] = Item::trailerItems()->count();
        $views           = Item::orderBy('id', 'desc')->limit(20)->get(['id', 'title', 'view']);

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'item', 'views'));
    }
