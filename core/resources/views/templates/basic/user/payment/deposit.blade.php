                            ...
                            <div class="row justify-content-center gy-sm-4 gy-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="payment-system-list p-3">
                                        <div class="deposit-info">
                                            ...
                                            <div class="deposit-info__input">
                                                <div class="deposit-info__input-group input-group">
                                                    ...
                                                    <input type="text" class="form-control form--control amount" name="amount" value="{{ getAmount($amount) }}" autocomplete="off" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <button type="submit" class="btn btn--base w-100" disabled>@lang('Confirm Payment')</button>
