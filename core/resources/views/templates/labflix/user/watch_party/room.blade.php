                    ...
                    <div class="watch-party-video-info">
                        <div class="top">
                            ...
                            @if ($partyRoom->user_id == auth()->id())
                                <button class="btn btn--danger cancelPartyBtn" data-action="{{ route('user.watch.party.cancel', $partyRoom->id) }}" type="button">@lang('Cancel Party')</button>
                            @else
                                <button class="btn btn--danger leavePartyBtn" data-action="{{ route('user.watch.party.leave', [$partyRoom->id, auth()->id()]) }}" type="button">@lang('Leave Party')</button>
                            @endif
                        </div>
                        <div class="bottom">
                            <div class="author">
    ...
    <script>
        ...
        (function($) {
            ...
            function conversationMessage(data) {
                ...
                console.log(members.includes(hostId), members);
